...
func (x *MemberLevelChange) Reset() {
	*x = MemberLevelChange{}
	if protoimpl.UnsafeEnabled {
...
func (x *MemberLevelChange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MemberLevelChange) ProtoMessage() {}

func (x *MemberLevelChange) ProtoReflect() protoreflect.Message {
	mi := &file_pb_room_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MemberLevelChange.ProtoReflect.Descriptor instead.
func (*MemberLevelChange) Descriptor() ([]byte, []int) {
	return file_pb_room_proto_rawDescGZIP(), []int{12}
}

func (x *MemberLevelChange) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *MemberLevelChange) GetRoomID() int32 {
	if x != nil {
		return x.RoomID
	}
	return 0
...
func (x *MemberLevelChange) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
type Answer struct {
	...
	QuestionID string `protobuf:"bytes,3,opt,name=QuestionID,proto3" json:"QuestionID,omitempty"` // 问题ID
...
type Say struct {
	...
	RoomID int32  `protobuf:"varint,1,opt,name=RoomID,proto3" json:"RoomID,omitempty"` // 对应的房间ID
	Uuid   string `protobuf:"bytes,2,opt,name=Uuid,proto3" json:"Uuid,omitempty"`      // 用户服务端uuid
	Word   string `protobuf:"bytes,3,opt,name=word,proto3" json:"word,omitempty"`      // 说话内容
}
...
type Question struct {
	...
	ID          string `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`                     // 题库ID
	...
	RightNumber int32  `protobuf:"varint,9,opt,name=RightNumber,proto3" json:"RightNumber,omitempty"`  // 正确统计
	WrongNumber int32  `protobuf:"varint,10,opt,name=WrongNumber,proto3" json:"WrongNumber,omitempty"` // 错误统计
...
func (x *Question) GetRightNumber() int32 {
	if x != nil {
...
func (x *Question) GetWrongNumber() int32 {
	if x != nil {
		return x.WrongNumber
	}
	return 0
}
...
type MemberRequest struct {
	...
	BattleRoomID int32  `protobuf:"varint,3,opt,name=BattleRoomID,proto3" json:"BattleRoomID,omitempty"` // 战斗房间ID
}
...
// 准备
type MemberReadyRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MemberReadyRequest) Reset() {
	*x = MemberReadyRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MemberReadyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MemberReadyRequest) ProtoMessage() {}

func (x *MemberReadyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pb_room_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MemberReadyRequest.ProtoReflect.Descriptor instead.
func (*MemberReadyRequest) Descriptor() ([]byte, []int) {
	return file_pb_room_proto_rawDescGZIP(), []int{31}
}

func (x *MemberReadyRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *MemberReadyRequest) GetRoomID() int32 {
	if x != nil {
		return x.RoomID
	}
	return 0
...
// 取消准备
type MemberReadyCancelRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MemberReadyCancelRequest) Reset() {
	*x = MemberReadyCancelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_room_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MemberReadyCancelRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MemberReadyCancelRequest) ProtoMessage() {}

func (x *MemberReadyCancelRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pb_room_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MemberReadyCancelRequest.ProtoReflect.Descriptor instead.
func (*MemberReadyCancelRequest) Descriptor() ([]byte, []int) {
	return file_pb_room_proto_rawDescGZIP(), []int{32}
}

func (x *MemberReadyCancelRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *MemberReadyCancelRequest) GetRoomID() int32 {
	if x != nil {
		return x.RoomID
	}
	return 0
...
type Member struct {
	...
	Level        int32     `protobuf:"varint,14,opt,name=Level,proto3" json:"Level,omitempty"`               // 段位等级
	IsAnswered   bool      `protobuf:"varint,15,opt,name=IsAnswered,proto3" json:"IsAnswered,omitempty"`     // 是否已经答题
}

func (x *Member) Reset() {
	*x = Member{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_room_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Member) Descriptor() ([]byte, []int) {
	return file_pb_room_proto_rawDescGZIP(), []int{33}
}
...
func (x *Member) GetIsAnswered() bool {
	if x != nil {
		return x.IsAnswered
	}
	return false
...
type RoomInfoReply struct {
	...
	BattleRoomID   int32     `protobuf:"varint,12,opt,name=BattleRoomID,proto3" json:"BattleRoomID,omitempty"` // 战斗房间ID
	SceneID        int32     `protobuf:"varint,13,opt,name=SceneID,proto3" json:"SceneID,omitempty"`           // 场景ID
}

func (x *RoomInfoReply) Reset() {
	*x = RoomInfoReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_room_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoomInfoReply) Descriptor() ([]byte, []int) {
	return file_pb_room_proto_rawDescGZIP(), []int{34}
}
...
func (x *RoomInfoReply) GetSceneID() int32 {
	if x != nil {
		return x.SceneID
	}
	return 0
...
func (x *RoomChangeState) Reset() {
	*x = RoomChangeState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_room_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RoomChangeState) Descriptor() ([]byte, []int) {
	return file_pb_room_proto_rawDescGZIP(), []int{35}
}
...
var file_pb_room_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x06, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x55, 0x0a, 0x11, 0x4d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x55, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x55, 0x75,
	0x69, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x06, 0x52, 0x6f, 0x6f, 0x6d, 0x49, 0x44, 0x12, 0x14, 0x0a, 0x05, 0x4c, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_pb_room_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_pb_room_proto_goTypes = []interface{}{
	...
	(*MemberLevelChange)(nil),        // 12: msg.MemberLevelChange
	(*MatchMemberRequest)(nil),       // 13: msg.MatchMemberRequest
	(*MatchMemberReply)(nil),         // 14: msg.MatchMemberReply
	(*RoomPreAddRequest)(nil),        // 15: msg.RoomPreAddRequest
	(*RoomPreAddReply)(nil),          // 16: msg.RoomPreAddReply
	(*MatchMemberCancelRequest)(nil), // 17: msg.MatchMemberCancelRequest
	(*MatchMemberCancelReply)(nil),   // 18: msg.MatchMemberCancelReply
	(*OfflineRequest)(nil),           // 19: msg.OfflineRequest
	(*AddRequest)(nil),               // 20: msg.AddRequest
	(*AddReply)(nil),                 // 21: msg.AddReply
	(*LeaveRequest)(nil),             // 22: msg.LeaveRequest
	(*LeaveReply)(nil),               // 23: msg.LeaveReply
	(*OverRequest)(nil),              // 24: msg.OverRequest
	(*OverReply)(nil),                // 25: msg.OverReply
	(*Answer)(nil),                   // 26: msg.Answer
	(*AnswerEndReply)(nil),           // 27: msg.AnswerEndReply
	(*Say)(nil),                      // 28: msg.Say
	(*Question)(nil),                 // 29: msg.Question
	(*MemberRequest)(nil),            // 30: msg.MemberRequest
	(*MemberReadyRequest)(nil),       // 31: msg.MemberReadyRequest
	(*MemberReadyCancelRequest)(nil), // 32: msg.MemberReadyCancelRequest
	(*Member)(nil),                   // 33: msg.Member
	(*RoomInfoReply)(nil),            // 34: msg.RoomInfoReply
	(*RoomChangeState)(nil),          // 35: msg.RoomChangeState
}
var file_pb_room_proto_depIdxs = []int32{
	33, // 0: msg.CreateRoomRequest.member:type_name -> msg.Member
	34, // 1: msg.MatchRoomReply.RoomInfo:type_name -> msg.RoomInfoReply
	26, // 2: msg.MemberReliveReply.Answer:type_name -> msg.Answer
	33, // 3: msg.MatchMemberRequest.Member:type_name -> msg.Member
	34, // 4: msg.MatchMemberReply.RoomInfo:type_name -> msg.RoomInfoReply
	33, // 5: msg.AddRequest.member:type_name -> msg.Member
	34, // 6: msg.AddReply.RoomInfo:type_name -> msg.RoomInfoReply
	33, // 7: msg.LeaveRequest.member:type_name -> msg.Member
	33, // 8: msg.OverRequest.member:type_name -> msg.Member
	34, // 9: msg.AnswerEndReply.RoomInfo:type_name -> msg.RoomInfoReply
	26, // 10: msg.Member.Answer:type_name -> msg.Answer
	33, // 11: msg.RoomInfoReply.PrepareMembers:type_name -> msg.Member
	33, // 12: msg.RoomInfoReply.PlayingMembers:type_name -> msg.Member
	33, // 13: msg.RoomInfoReply.ChangeMemeber:type_name -> msg.Member
	29, // 14: msg.RoomInfoReply.Question:type_name -> msg.Question
	0,  // 15: msg.Room.Connect:input_type -> msg.RoomServerConnectRequest
	1,  // 16: msg.Room.Create:input_type -> msg.CreateRoomRequest
	20, // 17: msg.Room.Add:input_type -> msg.AddRequest
	22, // 18: msg.Room.Leave:input_type -> msg.LeaveRequest
	24, // 19: msg.Room.Over:input_type -> msg.OverRequest
	26, // 20: msg.Room.AnswerQuestion:input_type -> msg.Answer
	4,  // 21: msg.Room.MatchRoom:input_type -> msg.MatchRoomRequest
	13, // 22: msg.Room.MatchMember:input_type -> msg.MatchMemberRequest
	4,  // 23: msg.Room.MatchRoomCancel:input_type -> msg.MatchRoomRequest
	22, // 24: msg.Room.MatchMemberCancel:input_type -> msg.LeaveRequest
	19, // 25: msg.Room.Offline:input_type -> msg.OfflineRequest
	2,  // 26: msg.Room.Connect:output_type -> msg.CreateRoomReply
	35, // 27: msg.Room.Create:output_type -> msg.RoomChangeState
	35, // 28: msg.Room.Add:output_type -> msg.RoomChangeState
	35, // 29: msg.Room.Leave:output_type -> msg.RoomChangeState
	35, // 30: msg.Room.Over:output_type -> msg.RoomChangeState
	35, // 31: msg.Room.AnswerQuestion:output_type -> msg.RoomChangeState
	35, // 32: msg.Room.MatchRoom:output_type -> msg.RoomChangeState
	35, // 33: msg.Room.MatchMember:output_type -> msg.RoomChangeState
	35, // 34: msg.Room.MatchRoomCancel:output_type -> msg.RoomChangeState
	35, // 35: msg.Room.MatchMemberCancel:output_type -> msg.RoomChangeState
	35, // 36: msg.Room.Offline:output_type -> msg.RoomChangeState
...
func file_pb_room_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_room_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MemberLevelChange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_room_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MemberReadyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_room_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MemberReadyCancelRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_room_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Member); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pb_room_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pb_room_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
